...
const DesktopNav = () => {
  ...
  const desktopNav = (
    <nav className="z-40 fixed flex h-[120px] w-full justify-start py-8 text-xl bg-white shadow-sm shadow-black">
      <div className='absolute -translate-y-[20px] translate-x-[28px]'>
